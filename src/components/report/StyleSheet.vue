    ...
    <div class="content">
      <div v-if="css" class="css-output">
        ...
        <p>
          ...
          >. This means applied layout feature will cascade predictably, and you
          can simply combine classes to use multiple layout features together.
        </p>
      ...
      <div v-else>
        <strong>There is no CSS needed for this font!</strong> You can use it
        without any special CSS — if there are any layout features in the font,
        they’ll be turned on automatically by the browser.
      </div>
    </div>
  </section>
</template>
