  ...
  <section id="tester">
    ...
    <div class="content tester-container">
      <div
        class="tester"
        :class="{ sticky }"
        :style="`${variableStyles}${featureStyles}${textStyles}` | inlinestyle"
        :lang="language"
      >
        <button
        ...
        <p spellcheck="false" dir="auto" contenteditable v-if="customText">
          {{ customText }}
        </p>
        <p spellcheck="false" dir="auto" contenteditable v-else>
          ...
          <br />
          <br />
          Ingredients: eggs, cheese, butter, pepper and salt. Take the same
          number of eggs as there are guests; weigh the eggs in the shell, allow
          a third of their weight in Gruyère cheese, and a piece of butter
          one-sixth of the weight of the cheese. Break the eggs into a basin,
          beat them well; add the cheese, which should be grated, and the
          butter, which should be broken in small pieces. Stir these ingredients
          ...
          good sprinkling of pepper, and serve the fondue on a very hot silver
          or metal plate. Do not allow the fondue to remain on the fire after
          the mixture is set, as, if it boils, it will be entirely spoilt.
          0123456789 !@#$%^&*(),.?
        </p>
      </div>
